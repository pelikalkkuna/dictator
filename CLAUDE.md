...
- **Testaus:** `node --test testit/*.test.js` (tai `npm test`) — 136 testiä kattaa kassaraportin, mittarien rajauksen, audienssit, presidentin päätökset, uutisvaiheen, sodan, kriisit, attentaatin, paon, pisteytyksen, kuukausikierroksen vaihejärjestyksen, poliisiraportin ja suurvalta-avun, kaikki vihreää. UI-vuorovaikutus (swipe, vaiheiden napit, paneelien näkyvyys) testataan Playwrightilla selaimessa, ei Node-testeissä.
