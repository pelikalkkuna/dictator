...
- **KYSYTTÄVÄ SASULTA — N5:** "Banaanien hinta romahtaa" → "Kassatulot laskevat" / "−tuloja" ei sisällä GDD:ssä mitään numeroa. Koodissa (`js/data/uutiset.js`, `erikoinen: "N5_EI_MAARITELTY"`) kortti kuluu pakasta mutta EI TEE MITÄÄN vielä. Odottaa Sasun vahvistusta.
